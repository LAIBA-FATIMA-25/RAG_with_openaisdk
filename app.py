...
from agents import Agent, FunctionTool, RunContextWrapper, function_tool, OpenAIChatCompletionsModel
import nest_asyncio
from tools.scraper_tool import scrape_and_embed_website
...
async def main(message: cl.Message):
 ...
 tools=[scrape_and_embed_website],
